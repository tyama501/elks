...
{
  unsigned int __far *hma0;
  unsigned int __far *conventional0;
  unsigned int original_val;

  hma0 = (unsigned int __far *) 0xFFFF0010;
  conventional0 = (unsigned int __far *) 0;
  original_val = *hma0;
  *conventional0 = ~original_val;
  if (*hma0 == *conventional0)
    return 0;
  else
    return 1;
